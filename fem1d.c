...
# define NL   2
  ...
  //Reorganise variable assignments from stack to heap
  double *adiag;
  double *aleft;
  double *arite;
  double *f;
  ...
  //Allocate appropriate heap arrays
  ...
  node   = (int *)   malloc(sizeof(int)   *(NSUB*NL));
  ...
  //Working on the new method of timing
